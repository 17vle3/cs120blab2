...
unsigned char row[4] = {0b1000,0b10000, 0b100000,0b1000000, 0b01111110 }; //0 1 2 3 all
...
unsigned const char songSize = 4;
...
int displayUpdate(int state){
	...
	switch (state) { 
		case display_start:
			transmit_data(0xFF);
			transmit_data2 (rowOutput|0b10000000);
			PORTB = points;
			break;
		default:
			break;
